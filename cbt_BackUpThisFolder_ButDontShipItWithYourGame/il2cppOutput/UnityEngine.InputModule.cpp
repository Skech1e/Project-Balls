	...
	union
	{
		struct
		{
			union
			{
				...
				struct
				{
					char ___sizeInBytes_1_OffsetPadding[4];
					// System.UInt16 UnityEngineInternal.Input.NativeInputEvent::sizeInBytes
					uint16_t ___sizeInBytes_1;
				};
				#pragma pack(pop, tp)
				#pragma pack(push, tp, 1)
				struct
				{
					char ___sizeInBytes_1_OffsetPadding_forAlignmentOnly[4];
					uint16_t ___sizeInBytes_1_forAlignmentOnly;
				};
				#pragma pack(pop, tp)
				#pragma pack(push, tp, 1)
				struct
				{
					char ___deviceId_2_OffsetPadding[6];
					// System.UInt16 UnityEngineInternal.Input.NativeInputEvent::deviceId
					uint16_t ___deviceId_2;
				};
				#pragma pack(pop, tp)
				#pragma pack(push, tp, 1)
				struct
				{
					char ___deviceId_2_OffsetPadding_forAlignmentOnly[6];
					uint16_t ___deviceId_2_forAlignmentOnly;
				};
				#pragma pack(pop, tp)
				#pragma pack(push, tp, 1)
				struct
				{
					char ___time_3_OffsetPadding[8];
				...
				struct
				{
					char ___time_3_OffsetPadding_forAlignmentOnly[8];
					double ___time_3_forAlignmentOnly;
				};
				#pragma pack(pop, tp)
				#pragma pack(push, tp, 1)
				struct
				{
					char ___eventId_4_OffsetPadding[16];
				...
				struct
				{
					char ___eventId_4_OffsetPadding_forAlignmentOnly[16];
					int32_t ___eventId_4_forAlignmentOnly;
				};
				#pragma pack(pop, tp)
			};
		};
